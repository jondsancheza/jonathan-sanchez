...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_6bo00ef', 'template_4m44a6a', form.current, 'thfFwQRUNE2ijBfDH')
      .then((result) => {
    ...
    <div className="md:container px-5 py-14">
      ...
      <div className="flex gap-10 md:flex-row flex-col">
        <form 
          ...
          <input type="email" name="user_email" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$" placeholder="Email" required className="border border-slate-600 p-3 rounded"/>
